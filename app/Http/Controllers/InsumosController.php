...
class InsumosController extends Controller
{
   ...
   public function store(Request $request)
   {
       ...
       $insumo = new Insumo();
       $insumo->nombre = ucfirst(strtolower($request->nombre));
       $insumo->composicion_quimica = ucfirst(strtolower($request->composicion_quimica));
   ...
   // Show the form to edit an existing insumo
