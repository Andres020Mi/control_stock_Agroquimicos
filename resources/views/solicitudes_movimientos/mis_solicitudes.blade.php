    ...
    <div class="content-wrapper">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Mis Solicitudes de Movimientos</h3>
            </div>
            <div class="card-body">
                <div class="mb-3">
                                    ...
                                    <td>
                                        <div class="flex space-x-2">
                                            @if ($solicitud->estado === 'pendiente')
                                                <form action="{{ route('solicitudes_movimientos.cancelar', $solicitud->id) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas cancelar esta solicitud?');">
                                                    @csrf
                                                    @method('DELETE')
