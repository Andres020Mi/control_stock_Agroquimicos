...
@section('links_css_head')
    <style>
        /* Reutilizamos los estilos de la vista de Proveedores */
        .content-wrapper {
            padding: 20px;
        }
        ...
        .actions {
            display: flex;
            flex-wrap: nowrap; /* Cambiado a nowrap para mantenerlos en línea */
            gap: 0.5rem;
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    <a href="{{ route('almacenes.create') }}" class="btn btn-success">
                        <i class="fas fa-plus mr-1"></i> Crear Nuevo Almacén
                    </a>
                </div>

                <div class="table-responsive">
                    <table class="table table-hover" id="almacenesTabla">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Nombre</th>
...
@section('scritps_end_body')
    ...
    <script>
        $(document).ready(function() {
            var table = $('#almacenesTabla').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
